...
# From: https://note.com/kohya_ss/n/nf5893a2e719c
#
# Usage: python merge_vae.py <source checkpoint file VAE> <destination Checkpoint file of VAE to be replaced> <Output checkpoint file after replacement>
